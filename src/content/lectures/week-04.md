...
teachers:
  - marisol-quaye
related:
  - sessions/04-small-excuses-big-tells
...
- order denial, justification, and diffusion of responsibility by developmental appearance
- explain why justification requires a child to model the rule they're judged against
- use the developmental order as evidence for which parts of the taxonomy are instinctive
