...
description:
  The linguistic structures that let an excuse move blame without
  ever naming it
week: 2
date: 2026-03-02
teachers:
...
- identify passive voice, hedges, and nominalisation as agent-removal devices
- explain how each device moves blame without ever naming who is to blame
- rewrite an agent-removing sentence to restore the agent it hides
